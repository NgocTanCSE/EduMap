...
report_content = """# BÁO CÁO CHI TIẾT TIẾN ĐỘ & ĐỘ HOÀN THIỆN DỰ ÁN EDUMAP
...
with open('scratch/EduMap_Progress_Report.md', 'w', encoding='utf-8') as f:
    f.write(report_content)
print("Done writing progress report!")
