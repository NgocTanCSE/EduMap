...
export default function Home() {
  const storefrontSections = [
    {
      ...
      color: "from-yellow-500/20 to-cyan-500/20 border-yellow-500/30",
      items: [
        { name: "Bản Bản đồ Tương tác", href: "/map", desc: "Tìm trường học, thư viện, stem-labs, trạm wifi miễn phí bằng bán kính địa lý PostGIS ST_DWithin.", icon: MapIcon },
    ...
    },
    {
      ...
      items: [
        { name: "Diễn đàn Học tập", href: "/community", desc: "Tìm đồng đội dự án học tập, tham gia diễn đàn thảo luận nhóm học tập sôi nổi.", icon: Users },
        { name: "Green Campus", href: "/green", desc: "Sân chơi đổi rác tái chế lấy Green Points, thử thách xanh bảo vệ môi trường campus.", icon: Leaf },
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-background via-background/95 to-background text-foreground pb-24">
      ...
      <div className="relative overflow-hidden py-24 px-4 sm:px-6 lg:px-8 border-b border-white/5 bg-gradient-to-r from-yellow-600/10 via-purple-600/5 to-transparent">
        <div className="mx-auto max-w-7xl text-center space-y-8 relative z-10">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tight leading-none">
            ...
            <span className="bg-gradient-to-r from-yellow-500 via-indigo-500 to-violet-500 bg-clip-text text-transparent">
              Trong Tầm tay Bạn
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center pt-6">
            <a href="/map">
              <button className="h-12 px-8 rounded-full bg-yellow-600 hover:bg-yellow-700 text-white text-base font-medium shadow-lg shadow-yellow-500/25 active:scale-95 transition-all flex items-center gap-2">
                Trải nghiệm Bản đồ <ArrowRight className="w-5 h-5" />
              </button>
            </a>
            <a href="/ai-chat">
              <button className="h-12 px-8 rounded-full border border-white/10 hover:bg-card text-foreground text-base font-medium active:scale-95 transition-all flex items-center gap-2">
                Hỏi Trợ lý AI <MessageSquare className="w-5 h-5 text-yellow-500" />
              </button>
            </a>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 sm:p-8 rounded-3xl border border-white/10 bg-zinc-900/60 shadow-xl">
          <div className="text-center md:border-r border-white/5 py-2">
            <div className="text-3xl sm:text-4xl font-extrabold text-yellow-500">100+</div>
                ...
                return (
                  ...
                  >
                    <div className="space-y-4">
                      <span className="flex w-12 h-12 items-center justify-center rounded-2xl bg-card text-foreground border border-white/10 group-hover:bg-yellow-600 group-hover:text-white transition-all group-hover:rotate-6">
                        <IconComponent className="w-6 h-6" />
                      </span>
                      <div className="space-y-1">
                        <h3 className="text-lg font-bold tracking-tight group-hover:text-yellow-500 transition-colors">
                          {item.name}
                        </h3>
                    ...
                    <div className="flex items-center gap-1 text-xs font-semibold text-yellow-500 mt-6 opacity-0 group-hover:opacity-100 transition-opacity">
